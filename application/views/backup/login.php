...
<head>
  ...
  <title>Pengadilan Negeri Cikarang</title>
              ...
              <div class="col-lg-12 col-md-12">
                <div class="p-3">
                  <div class="text-center">
                    <div class="row">
                      <div class="col-12">
                        <marquee><label class="h4  text-success mb-1"><b><?= strtoupper("Selamat Datang di Pengadilan Negeri Cikarang");?></b></label></marquee>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="text-center">
                    <div class="row">
                      <div class="col-xl-6 col-md-12 mt-3">
                        <a class="btn btn-block btn-outline-info" href="<?= base_url()?>login/regis">Kontak Pengadilan Negeri Cikarang</a>
                      </div>

                      <div class="col-xl-6 col-md-12 mt-3">
                       <a class="btn btn-block btn-outline-success" href="<?= base_url()?>login/buat_janji">Buat Janji Konsultasi</a>
                      </div>
                    </div>
                  </div>
