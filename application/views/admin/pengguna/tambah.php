      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" role="form" action="<?= site_url('admin/pengguna/insert_proses');?>" method="post" enctype="multipart/form-data">
              <div class="box-body">

                <div class="form-group">
                  <label class="col-sm-4 control-label" style="text-align: left">Nama Pengguna</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="" name="nama_pengguna" placeholder="Masukan Nama Pengguna" required="">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="" name="username" placeholder="Masukan Username" required="">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="" name="password" placeholder="Masukan Password" required="">
                  </div>
                </div>
